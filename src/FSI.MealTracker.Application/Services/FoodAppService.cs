...
{
    public class FoodAppService : BaseAppService<FoodDto, FoodEntity>, IFoodAppService
    {
        public FoodAppService(IFoodRepository repository)
            : base(repository, new FoodMapper()) { }
    }
}